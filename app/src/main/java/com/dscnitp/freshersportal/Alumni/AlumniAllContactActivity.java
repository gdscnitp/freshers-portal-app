...
public class AlumniAllContactActivity extends AppCompatActivity {
    ...
    private void getAllUsers() {
        ...
        reference.orderByChild("USER_TYPE").equalTo("Alumni").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1:dataSnapshot.getChildren()) {
                    ...
                    AdapterUser user = new AdapterUser(AlumniAllContactActivity.this, modelUsers);
